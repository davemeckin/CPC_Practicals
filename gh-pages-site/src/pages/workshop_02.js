...
const Workshop02 = () => (
  <Layout>
  <Navbar/>
    <SEO title="Workshop 02" />
    <p></p>
    <h1>Hello and welcome back!</h1>
    <p>This second workshop will demonstrate the beginnings of how we can create generative systems in 3D to create simple structural forms. So, we will:</p>
	<p>
     <ul>
		  ...
		  <li>Have some space to play around with customising our system</li>
	</ul>
	</p>
 ...
 <p></p>
  ...
  audioLoader.load(
	...
	<code>
    <CodeBlock text = {`sound.offset = 0.0 + Math.random() * 0.05;
