...
const Workshop10 = ({data}) => (
  <Layout>
  <Navbar/>
    <SEO title="Workshop 10" />
    <p></p>
    <h1>Hello and welcome back!</h1>
    <h3> This is optional!</h3>
    <p>If you have come here without doing the previous worksheet (called Optional 10) please go back and do that before this one. The reason is that we are adding some sound stuff to that one this week, so we need to use that completed sheet (up to task 6) as a basis for what we're going to do this week.</p>
